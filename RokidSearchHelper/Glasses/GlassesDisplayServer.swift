// GlassesDisplayServer.swift — updated to use Rokid AI glasses SDK
...
final class GlassesDisplayServer: ObservableObject {
    ...
    func sendResult(query: String, answer: String, source: String) {
        ...
        RokidMobileSDK.vui.sendMessage(topic: "result", text: String(describing: query), to: dev)
    }
...
extension GlassesDisplayServer: SDKBinderObserver {
